...
export default function PUForm(props) {
  const navigate = useNavigate();
  const [trfile, settrFile] = React.useState();
  const [tifile, settiFile] = React.useState();
  ...
  const updateProject = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .put(`/project/update/${hash}`, Pdata, { headers: config.headers })
          .then((res) => {
            Toast.fire({
              icon: "success",
